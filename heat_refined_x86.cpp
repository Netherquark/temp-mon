...
int main()
{
    ...
    for (int it=0; it<=itmax ; it++){
      ...
      system("sudo turbostat --Summary --interval 0.001 --quiet --num_iterations 1 --out power.txt --hide "Avg_MHz" --hide "Busy%" --hide "Bzy_MHz" --hide "TSC_MHz" --hide "IPC" --hide "IRQ" --hide "POLL" --hide "C1" --hide "C2" --hide "C3" --hide "POLL%" --hide "C1%" --hide "C2%" --hide "C3%" --hide "PkgWatt"");
